                ...
                value.bind(function(newval) {
                    if (true == newval) {
						...
						if ( $("#customize-preview iframe").contents().find(".footer-love").length == 0) {
							$("#customize-preview iframe")
							.contents()
							.find("body").append( '<div class="footer-love">' + UCMM.customizer_strings[0] + '<a href="https://wpbrigade.com/wordpress/plugins/under-construction-maintenance-mode/" target="_blank">' + UCMM.customizer_strings[1] + '</a></div>' );
						}
                    } else {
                        $("#customize-preview iframe")
						.contents()
