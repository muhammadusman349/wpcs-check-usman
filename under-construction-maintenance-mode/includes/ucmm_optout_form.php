<?php
/**
 * under-construction-maintenance-mode optout Content.
 * @package under-construction-maintenance-mode
 * @since 1.5.4
 */
$pluginSlug = "under-construction-maintenance-mode";
$pluginName = "Under Construction Maintenance Mode";

$ucmm_optout_nonce = wp_create_nonce("ucmm-optout-nonce");
        ...
        $(function () {
            ...
            function send_optin_request(el, setting_name, setting_option_value) {
                $.ajax({
                    ...
                    data: {
                        action: 'ucmm_optout_yes',  // The action to trigger
                        setting_name: setting_name,  // The setting name (option)
                        setting_value: setting_option_value,  // The value (opt-in or opt-out)
                        optout_nonce: '<?php echo isset($ucmm_optout_nonce) ? $ucmm_optout_nonce : ''; ?>',  // Security nonce
                    },
                    beforeSend: function () {
